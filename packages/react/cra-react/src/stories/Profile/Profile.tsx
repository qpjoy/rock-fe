...
import { collections, people, tags } from "./people";
...
const Profile = () => {
  ...
  useEffect(() => {
    const getProfile = async () => {
      const person = await people.filter(
        (person: any) => parseInt(person.id) === parseInt(id)
      )[0];
      setProfile(person);
    };
    getProfile();
  ...
  return (
    <IonPage>
      ...
      <IonContent fullscreen>
        ...
        <div
          className={`${styles.collections} animate_animated animate__slideInRight`}
        >
