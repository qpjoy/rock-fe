...
export default class Lion implements IProteus {
  ...
  tellMeTheFuture(): void {
    if (Math.floor(Math.random() * 2)) {
      ...
      this.tellMeTheFuture =
        Serpent.prototype.tellMeTheFuture;
      this.tellMeYourForm =
        Serpent.prototype.tellMeYourForm;
    } else {
      Object.assign(this, new Leopard());
      this.tellMeTheFuture =
        Leopard.prototype.tellMeTheFuture;
      this.tellMeYourForm =
        Leopard.prototype.tellMeYourForm;
    }
  }
